...
btn_whois.grid(row=0, column=0, padx=2, sticky="w")
btn_pdns.grid(row=0, column=1, padx=2, sticky="w")
btn_shodan.grid(row=0, column=2, padx=2, sticky="w")
btn_shodan_search.grid(row=1, column=2, padx=2, sticky="w")
btn_censys_cert_lookup.grid(row=0, column=3, padx=2, sticky="w")
btn_censys_cert_search.grid(row=1, column=3, padx=2, sticky="w")
btn_censys_host_view.grid(row=2, column=3, padx=2, sticky="w")
btn_clear.grid(row=0, column=4, padx=2, sticky="w")
